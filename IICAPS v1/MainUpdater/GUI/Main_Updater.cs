...
{
    public partial class Main_Updater : Form
    {
        public Main_Updater()
        {
            InitializeComponent();
        ...
        private void obtenerPath()
        {
            try
            {
                lblMensaje.Text = "Abriendo IICAPS ERP";
                Thread.Sleep(3000);
                this.Dispose();
            ...
            {
                MessageBox.Show("Ha ocurrido un error al intentar abrir la aplicación, si el problema persiste contacte con soporte técnico");
                Application.Exit();
            }
        }
